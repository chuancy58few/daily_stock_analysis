...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "RSS_ENABLED": {
        "title": "RSS Enabled",
        "description": "Enable free RSS news provider (Google News RSS).",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "RSS_FEED_TEMPLATE": {
        ...
        "description": "RSS feed URL template. Use {q} as query placeholder.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "https://news.google.com/rss/search?q={q}&hl=zh-CN&gl=CN&ceid=CN:zh-Hans",
        "options": [],
        "validation": {},
        "display_order": 56,
    },
    "RSS_MAX_RESULTS": {
        "title": "RSS Max Results",
        "description": "Maximum RSS items to keep after filtering.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "BROKER_RATINGS_ENABLED": {
        "title": "Broker Ratings Enabled",
        "description": "Enable manual broker ratings overlay in summary.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "BROKER_RATINGS_PATH": {
        "title": "Broker Ratings Path",
        "description": "Path to broker_ratings.csv.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "broker_ratings.csv",
        "options": [],
        "validation": {},
        "display_order": 59,
    },
