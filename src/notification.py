...
class NotificationService:
    ...
    def generate_daily_report(
        ...
        if self._report_summary_only:
            ...
            for r in sorted_results:
                report_lines.append(self._build_summary_line(r))
        else:
    ...
    @staticmethod
    def _build_summary_line(r: AnalysisResult, emoji=None) -> str:
        snapshot = getattr(r, "market_snapshot", None) or {}
    ...
    def generate_dashboard_report(
        ...
        if results:
            ...
            for r in sorted_results:
                ...
                report_lines.append(self._build_summary_line(r, emoji=signal_emoji))
            report_lines.extend(
                [
                    "",
                    "---",
    ...
    def generate_wechat_dashboard(self, results: List[AnalysisResult]) -> str:
        ...
        if self._report_summary_only:
            ...
            for r in sorted_results:
                _, signal_emoji, _ = self._get_signal_level(r)
                lines.append(self._build_summary_line(r, emoji=signal_emoji))
        else:
            for result in sorted_results:
    ...
    def _send_wechat_message(self, content: str) -> bool:
        ...
        response = requests.post(
            self._wechat_url, json=payload, timeout=10, verify=self._webhook_verify_ssl
        )
...
class NotificationBuilder:
    ...
    def build_stock_summary(results: List[AnalysisResult]) -> str:
        ...
        for r in sorted(results, key=lambda x: x.sentiment_score, reverse=True):
            lines.append(NotificationService._build_summary_line(r))
